...
import { MiddleSectionVisibleaction, requestSplit, setActiveid, setsaveDraftId, setSaveDraftname, settoolbarview } from "./store/editorSetting";
      ...
      <div className="main-wrapper flex" onMouseMove={handleMouseMove}
        ...
        <div className="sidebar-menu">
          ...
          <div className="sidebar-items-list">
            ...
            <div className="sidebar-items">
              <button
                onClick={() => dispatch(settoolbarview("image"))}
                className="items-link"
              >
            ...
            <div className="sidebar-items">
              <button
                onClick={() => dispatch(settoolbarview("video"))}
                className="items-link"
              >
                ...
                <>
                  ...
                  >
                    <div className="flex items-center justify-between pt-2 pb-4">
                      {/* Popup Content */}
                      <h2 className="text-xl font-semibold kd-white-color">Rendering</h2>

...
> = ({ onClick, disabled, children, loading, secondary }, ref) => {
  return (
    <button
      ref={ref}
      className={cn(
        "  kd-primary-btn float-right h-10 font-medium transition-all duration-150 ease-in-out inline-flex items-center appearance-none text-sm    disabled:cursor-not-allowed",
        secondary
          ? "kd-primary-btn "
          : undefined,
      )}

...
const Template: React.FC = () => {
  ...
  const template_catagary = [
    ...
    { id: 1, name: 'Advertisement', value: 'advertisement' },
    { id: 2, name: 'Ecommerce', value: 'ecommerce' },
    { id: 3, name: 'Learning & Development', value: 'learningdevelopment' },
    { id: 4, name: 'Explainer Video', value: 'explainervideo' },
    { id: 5, name: 'Social Media', value: 'socialmedia' },
    { id: 6, name: 'Business Card', value: 'businesscard' },
    { id: 7, name: 'Health & Medical', value: 'healthandmedical' },
    { id: 8, name: 'Festival', value: 'festival' },
    { id: 9, name: 'Breaking News', value: 'brekingnews' },
